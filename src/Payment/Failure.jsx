    ...
    <div className="payment-failure">
      <div className="payment-failure-content">
        <div className="payment-failure-message">
          ...
          <p>-------------------</p>
          <p>pls try again, if your money has been deducted it will be refunded within 5-7 working days.</p>
          <p>-------------------</p>
          <p>for any queries, Email us on: care@looplove.in</p>
          <p>-------------------</p>
        </div>
        <div className="back-link" onClick={() => navigate("/")}>Back to Home</div>
      </div>
    </div>
  );
};
